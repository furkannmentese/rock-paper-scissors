...
<template>
  <section class="relative max-w-[1000px] mx-auto grid grid-cols-3 gap-8 place-items-center pt-16">
    ...
    <div class="grid place-items-center">
      <h3 class="text-6xl pb-6 uppercase font-bold text-center text-white">
